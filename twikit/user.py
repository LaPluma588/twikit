...
class User:
    ...
    def __init__(self, client: Client, data: dict) -> None:
        ...
        # Patched 2026-05-17 (unclecode/twikit fork): X has been dropping
        # fields from the user `legacy` dict over time (e.g. withheld_in_countries,
        # entities.description.urls, fast_followers_count). Use .get() with
        # safe defaults for everything so a single missing field doesn't kill
        # a 20-tweet fetch. Names and types preserved.
        ...
        _entities = legacy.get('entities') or {}
        _desc_ent = _entities.get('description') or {}
        self.description_urls: list = _desc_ent.get('urls', [])
        _url_ent = _entities.get('url') or {}
        self.urls: list = _url_ent.get('urls', [])
        ...
        self.verified_type:str = legacy.get('verified_type','')
